...
function Footer() {
  return (
    <footer className="bg-gradient-to-r from-blue-50 via-blue-100 to-blue-50 text-blue-900 mt-8 relative overflow-hidden">
      {/* Animated background elements */}
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-6">
            <a href="/dashboard" className="footer-link text-blue-700 hover:text-indigo-600 transition-all duration-300 text-sm hover:scale-110 transform hover:shadow-lg hover:shadow-indigo-400/20 px-3 py-1 rounded-md">
              Dashboard
            </a>
            <a href="/register" className="footer-link text-blue-700 hover:text-emerald-600 transition-all duration-300 text-sm hover:scale-110 transform hover:shadow-lg hover:shadow-emerald-400/20 px-3 py-1 rounded-md">
              Register
            </a>
            <a href="/book" className="footer-link text-blue-700 hover:text-emerald-600 transition-all duration-300 text-sm hover:scale-110 transform hover:shadow-lg hover:shadow-emerald-400/20 px-3 py-1 rounded-md">
              Book
            </a>
            <a href="#" className="footer-link text-blue-700 hover:text-pink-600 transition-all duration-300 text-sm hover:scale-110 transform hover:shadow-lg hover:shadow-pink-400/20 px-3 py-1 rounded-md">
              How It Works
            </a>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <a href="#" className="footer-social text-blue-600 hover:text-indigo-600 transition-all duration-300 text-lg p-2 rounded-full hover:bg-indigo-400/10">
        ...
        <div className="mt-4 pt-4 border-t border-blue-300/50 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-blue-600 text-xs">
            © 2025 ChargeShare. All rights reserved.
          </p>
          <div className="flex items-center space-x-4">
            <a href="#" className="footer-link text-blue-600 hover:text-blue-800 transition-all duration-300 text-xs hover:underline hover:scale-105 transform px-2 py-1 rounded">
              Privacy
            </a>
            <a href="#" className="footer-link text-blue-600 hover:text-blue-800 transition-all duration-300 text-xs hover:underline hover:scale-105 transform px-2 py-1 rounded">
              Terms
